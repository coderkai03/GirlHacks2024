...
export default function ProfilePreview({ userData, glowColor }: { userData: UserData, glowColor: string }) {
    return (
        <div className="flex items-center justify-center min-h-screen"> {/* Flexbox to center the card */}
            <div 
                className="mt-6 bg-black rounded-lg shadow-2xl border-2 border-white relative w-full max-w-[600px] h-[350px] p-4" 
                style={{
